...
绝地潜兵2 自动呼叫战备工具 — Helldivers 2 Auto Stratagem Caller

黑金科幻风格的 PyQt6 桌面应用，一键自动输入战备指令码，支持 Profile 存档管理。
